...
@Extension(
        ...
        description = "" +
                ...
                "map your stream values with protobuf message object.  You can even use protobuf Maps with this " +
                "mapper, In order to use maps you should use  HashMap " +
                ", LinkedHashMap or TreeMap and pass them directly to the stream as an object. " +
                "   ",
        parameters = {
