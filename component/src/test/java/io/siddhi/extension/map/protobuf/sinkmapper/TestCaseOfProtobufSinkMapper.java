...
public class TestCaseOfProtobufSinkMapper {
    ...
    @Test
    public void protobuSinkMapperTestCaseWithUnderscore() throws InterruptedException {
        InMemoryBroker.Subscriber subscriber = new InMemoryBroker.Subscriber() {
            @Override
            public void onMessage(Object o) {
                MessageWithUnderscore messageWithUnderscore = MessageWithUnderscore.newBuilder()
                        .setDoubleValue(100.123)
                        .setIntValue(1000)
                        .setStringValue("Test 001")
                        .build();
                AssertJUnit.assertEquals(messageWithUnderscore.toByteArray(), (byte[]) o);
            }
        ...
        InputHandler stockStream = siddhiAppRuntime.getInputHandler("FooStream");
        siddhiAppRuntime.start();
        Object[] data1 = {"Test 001", 1000, 100.123};
        stockStream.send(data1);
        siddhiAppRuntime.shutdown();
        //unsubscribe from "inMemory" broker per topic
        InMemoryBroker.unsubscribe(subscriber);
