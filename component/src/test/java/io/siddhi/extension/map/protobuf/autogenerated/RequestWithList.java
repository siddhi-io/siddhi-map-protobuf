...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return Sample.internal_static_RequestWithList_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return Sample.internal_static_RequestWithList_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            RequestWithList.class, Builder.class);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof RequestWithList)) {
      return super.equals(obj);
    }
    RequestWithList other = (RequestWithList) obj;
  ...
  public static RequestWithList parseFrom(
  ...
  public static RequestWithList parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static RequestWithList parseFrom(
  ...
  public static RequestWithList parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static RequestWithList parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static RequestWithList parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(RequestWithList prototype) {
  ...
  public static final class Builder extends
    ...
    @Override
    public RequestWithList getDefaultInstanceForType() {
      return RequestWithList.getDefaultInstance();
    }

    @Override
    public RequestWithList build() {
      RequestWithList result = buildPartial();
    ...
    @Override
    public RequestWithList buildPartial() {
      RequestWithList result = new RequestWithList(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof RequestWithList) {
        return mergeFrom((RequestWithList)other);
      } else {
    ...
    public Builder mergeFrom(RequestWithList other) {
      if (other == RequestWithList.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      RequestWithList parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (RequestWithList) e.getUnfinishedMessage();
  ...
  private static final RequestWithList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new RequestWithList();
  }

  public static RequestWithList getDefaultInstance() {
